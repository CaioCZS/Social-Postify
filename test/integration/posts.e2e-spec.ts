...
describe('Posts', () => {
  ...
  describe('POST /', () => {
    ...
    it('should create a new post in db', async () => {
      ...
      const postCreated = await prisma.posts.findFirst();
  ...
  describe('PUT /:id', () => {
    ...
    it('should update post data in db', async () => {
      ...
      const postChanged = await prisma.posts.findUnique({
        where: { id: post.id },
      });
  ...
  describe('DELETE /:id', () => {
    ...
    it('should delete the post in db', async () => {
      ...
      const isDeleted = await prisma.posts.findUnique({
        where: { id: post.id },
      });
